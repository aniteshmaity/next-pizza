...
console.log(credentials);
      ...
      // const existingUser = await Users.findOne({ where: { email: credentials.email } });
      // if(existingUser){
      //   alert("email exists");
      //   return;
      // }
      ...
      try {
        ...
        if (userData.success) {
          ...
          console.log('Signup failed:', userData.message);
          toast.warning('Signup failed:', userData.message);
        }
      } catch (error) {
        console.log(error);
