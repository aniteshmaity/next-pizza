...
const Navbar = () => {
  ...
  if (!mounted) return null; // Avoids mismatch during SSR
  ...
  return (
    ...
    <>
        <header className="text-white-100 sticky top-0 z-50 bg-gradient-to-r from-indigo-700 via-blue-950 to-orange-700 body-font">
